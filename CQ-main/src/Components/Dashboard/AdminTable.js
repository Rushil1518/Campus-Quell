...
function AdminTable(props) {
  ...
  return (
    <div>
      ...
      {forwardModal && (
        <div className="z-10 bg-slate-800 bg-opacity-50 flex justify-center items-center absolute top-0 right-0 bottom-0 left-0">
          <div className=" bg-white px-16 py-14 rounded-md text-center border ">
            ...
            <button
              onClick={() => {
                props.setComplaintsFwded(props.complaintsFwded + 1);
      ...
      <div className="h-[90vh] md:w-auto w-screen  overflow-scroll rounded-lg border border-gray-600 shadow-sm m-2">
